...
1. Run `tl describe channels --json` to discover filters
2. Translate the user's request into a `tl channels` command
3. Execute and present results

Examples:
- "/tl-channels cooking channels over 100k" → `tl channels category:cooking min-subs:100000`
- "/tl-channels 12345" → `tl channels 12345`
- "/tl-channels English gaming channels" → `tl channels category:gaming language:en`
